...
{
    var oneFriend=''+
        '<li id="friend_'+friend.id+'" class="piece_box"  data-nickname="'+friend.nickname+'" data-groupid="'+group_id+'">'+
        '<div class="piece_icon">'+
        '<img class="piece_url" onclick="showContentBox('+friend.id+')"'+
        'src="/static/image/avatar/'+friend.pic_id+'.jpg">'+
        '</div>'+
        '<div class="piece_info2">'+
        '<span class="piece_name">'+friend.nickname+'</span>'+
        '<i class="fa fa-ban" onclick="deleteFriend('+friend.id+
        ')" style="position:absolute;left: 90%;top:50%;transform: translate(-100%,-50%);">'+
        '</div>'+
        '</li>';
